...
export default LoginFarmer = ({navigation}) => {
    ...
    return (
        <SafeAreaView style={{backgroundColor:'white', height:height, width:width}}>
            ...
            <View style={{position:'absolute', top:340}}>
              <Text style={{fontWeight:'300' , marginLeft:130, color:'white'}}>Farmer Login</Text>
              ...
              <TouchableOpacity onPress={()=>navigation.navigate('Far_reg')} style={{width:width, ...styles.center, marginTop:13}}><Text style={{color:'white', fontWeight:'200'}}>New to Kishan Connect?  <Text style={{color:'cyan', fontWeight:'300'}}>Register here!</Text></Text></TouchableOpacity>
            </View>
        </SafeAreaView>
      );
    };

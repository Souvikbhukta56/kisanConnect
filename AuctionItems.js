    ...
    return(
        ...
        <View style={{flexDirection:'row', ...styles.center}}>
          ...
          <View style={{flexDirection: 'column', margin: 10}}>
            ...
            <View style={{borderWidth:.5, borderColor: '#1b9862', padding:5, margin:3, width:200, backgroundColor:'#f6f9ff'}}>
              <Text style={{color:'red',  fontWeight:'300'}}>Bidding Price: ₹{bp1}/kg</Text>
            ...
            <View style={{flexDirection:'row', marginTop:5, ...styles.center }}>
                ...
                <TouchableOpacity onPress={()=>{setText1('Selected');setColor1('red');
                get(child(dbref, 'ai')).then((snapshot) => {
                    storeData('ai', 'bp', [bp1+3, bp2, bp3, bp4, bp5, bp6, bp7]);
                    setDep(!dep);
                    }).catch((e) => alert(e));
                    
                }} style={{marginLeft: 30, padding:10, paddingTop:5, paddingBottom:5, backgroundColor:color1, borderRadius:5}}><Text style={{color:'white'}}>Bid</Text></TouchableOpacity>
            </View>
          </View>
        </View>
        ...
        <View style={{flexDirection:'row', ...styles.center}}>
          ...
          <View style={{flexDirection: 'column', margin: 10}}>
            ...
            <View style={{borderWidth:.5, borderColor: '#1b9862', padding:5, margin:3, width:200, backgroundColor:'#f6f9ff'}}>
              <Text style={{color:'red',  fontWeight:'300'}}>Bidding Price: ₹{bp3}/kg</Text>
              <Text style={{color:'green', fontWeight:'300'}}>Base Price: ₹15/kg</Text>
            </View>
            <View style={{flexDirection:'row', marginTop:5, ...styles.center }}>
                <Text style={{color:'blue'}}>Status: <Text style={{color:'red'}}>{status}</Text></Text>
                <TouchableOpacity onPress={()=>{setText3('Selected');setColor3('red');
                get(child(dbref, 'ai')).then((snapshot) => {
                    storeData('ai', 'bp', [bp1, bp2, bp3+3, bp4, bp5, bp6, bp7]);
                    setDep(!dep);
                    }).catch((e) => alert(e));
                    
                }} style={{marginLeft: 30, padding:10, paddingTop:5, paddingBottom:5, backgroundColor:color3, borderRadius:5}}><Text style={{color:'white'}}>Bid</Text></TouchableOpacity>
            </View>
          </View>
        </View>
        <View style={{backgroundColor: 'rgb(185, 185, 185)', width:'100%', height: 1}}></View>
        ...
        <View style={{flexDirection:'row', ...styles.center}}>
          ...
          <View style={{flexDirection: 'column', margin: 10}}>
            ...
            <View style={{borderWidth:.5, borderColor: '#1b9862', padding:5, margin:3, width:200, backgroundColor:'#f6f9ff'}}>
              <Text style={{color:'red',  fontWeight:'300'}}>Bidding Price: ₹{bp4}/kg</Text>
              <Text style={{color:'green', fontWeight:'300'}}>Base Price: ₹20/kg</Text>
            </View>
            <View style={{flexDirection:'row', marginTop:5, ...styles.center }}>
                <Text style={{color:'blue'}}>Status: <Text style={{color:'red'}}>{status}</Text></Text>
                <TouchableOpacity onPress={()=>{setText4('Selected');setColor4('red');
            get(child(dbref, 'ai')).then((snapshot) => {
                storeData('ai', 'bp', [bp1, bp2, bp3, bp4+3, bp5, bp6, bp7]);
                setDep(!dep);
                }).catch((e) => alert(e));
                
            }} style={{marginLeft: 30, padding:10, paddingTop:5, paddingBottom:5, backgroundColor:color4, borderRadius:5}}><Text style={{color:'white'}}>Bid</Text></TouchableOpacity>
            </View>
          </View>
        </View>
        <View style={{backgroundColor: 'rgb(185, 185, 185)', width:'100%', height: 1}}></View>
        ...
        <View style={{flexDirection:'row', ...styles.center}}>
          ...
          <View style={{flexDirection: 'column', margin: 10}}>
            ...
            <View style={{borderWidth:.5, borderColor: '#1b9862', padding:5, margin:3, width:200, backgroundColor:'#f6f9ff'}}>
              <Text style={{color:'red',  fontWeight:'300'}}>Bidding Price: ₹{bp7}/kg</Text>
              <Text style={{color:'green', fontWeight:'300'}}>Base Price: ₹70/kg</Text>
            </View>
            <View style={{flexDirection:'row', marginTop:5, ...styles.center }}>
                <Text style={{color:'blue'}}>Status: <Text style={{color:'red'}}>{status}</Text></Text>
                <TouchableOpacity onPress={()=>{setText7('Selected');setColor7('red');
            get(child(dbref, 'ai')).then((snapshot) => {
                storeData('ai', 'bp', [bp1, bp2, bp3, bp4, bp5, bp6, bp7+5]);
                setDep(!dep);
                }).catch((e) => alert(e));
                
            }} style={{marginLeft: 30, padding:10, paddingTop:5, paddingBottom:5, backgroundColor:color7, borderRadius:5}}><Text style={{color:'white'}}>Bid</Text></TouchableOpacity>
            </View>
          </View>
        </View>

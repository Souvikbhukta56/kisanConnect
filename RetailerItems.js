...
export default RetailerItems = () => {
    ...
    return(
        ...
        <View style={{flexDirection:'row', ...styles.center}}>
          ...
          <View style={{flexDirection: 'column', margin: 10}}>
            ...
            <View style={{flexDirection:'row', marginTop:5, ...styles.center }}>
                ...
                <TouchableOpacity onPress={()=>{setText1('Selected');setColor1('red')}} style={{marginLeft: 30, padding:10, paddingTop:5, paddingBottom:5, backgroundColor:color1, borderRadius:5}}><Text style={{color:'white'}}>{text1}</Text></TouchableOpacity>
            </View>
          </View>
        </View>
        ...
        <View style={{flexDirection:'row', ...styles.center}}>
          <TouchableOpacity style={{width:100, height:100, margin:15, elevation:5, backgroundColor:'black', borderRadius:5}}><Image  style={{width:100, height:100, borderRadius:5}} source={require('./assets/carrot.png')}/></TouchableOpacity>
          <View style={{flexDirection: 'column', margin: 10}}>
            ...
            <View style={{flexDirection:'row', marginTop:5, ...styles.center }}>
                <Text style={{color:'blue'}}>Status: <Text style={{color:'red'}}>Unsold</Text></Text>
                <TouchableOpacity onPress={()=>{setText2('Selected');setColor2('red')}} style={{marginLeft: 30, padding:10, paddingTop:5, paddingBottom:5, backgroundColor:color2, borderRadius:5}}><Text style={{color:'white'}}>{text2}</Text></TouchableOpacity>
            </View>
          </View>
        </View>
        <View style={{backgroundColor: 'rgb(185, 185, 185)', width:'100%', height: 1}}></View>
        ...
        <View style={{flexDirection:'row', ...styles.center}}>
          ...
          <View style={{flexDirection: 'column', margin: 10}}>
            ...
            <View style={{flexDirection:'row', marginTop:5, ...styles.center }}>
                <Text style={{color:'blue'}}>Status: <Text style={{color:'red'}}>Unsold</Text></Text>
                <TouchableOpacity onPress={()=>{setText3('Selected');setColor3('red')}} style={{marginLeft: 30, padding:10, paddingTop:5, paddingBottom:5, backgroundColor:color3, borderRadius:5}}><Text style={{color:'white'}}>{text3}</Text></TouchableOpacity>
            </View>
          </View>
        </View>
        <View style={{backgroundColor: 'rgb(185, 185, 185)', width:'100%', height: 1}}></View>
        ...
        <View style={{flexDirection:'row', ...styles.center}}>
          ...
          <View style={{flexDirection: 'column', margin: 10}}>
            ...
            <View style={{flexDirection:'row', marginTop:5, ...styles.center }}>
                <Text style={{color:'blue'}}>Status: <Text style={{color:'red'}}>Unsold</Text></Text>
                <TouchableOpacity onPress={()=>{setText4('Selected');setColor4('red')}} style={{marginLeft: 30, padding:10, paddingTop:5, paddingBottom:5, backgroundColor:color4, borderRadius:5}}><Text style={{color:'white'}}>{text4}</Text></TouchableOpacity>
            </View>
          </View>
        </View>
        <View style={{backgroundColor: 'rgb(185, 185, 185)', width:'100%', height: 1}}></View>
        <View style={{flexDirection:'row', ...styles.center}}>
          ...
          <View style={{flexDirection: 'column', margin: 10}}>
            ...
            <View style={{flexDirection:'row', marginTop:5, ...styles.center }}>
                <Text style={{color:'blue'}}>Status: <Text style={{color:'red'}}>Unsold</Text></Text>
                <TouchableOpacity onPress={()=>{setText5('Selected');setColor5('red')}} style={{marginLeft: 30, padding:10, paddingTop:5, paddingBottom:5, backgroundColor:color5, borderRadius:5}}><Text style={{color:'white'}}>{text5}</Text></TouchableOpacity>
            </View>
          </View>
        </View>
        <View style={{backgroundColor: 'rgb(185, 185, 185)', width:'100%', height: 1}}></View>
        ...
        <View style={{flexDirection:'row', ...styles.center}}>
          <TouchableOpacity style={{width:100, height:100, margin:15, elevation:5, backgroundColor:'black', borderRadius:5}}><Image  style={{width:100, height:100, borderRadius:5}} source={require('./assets/rice.jpg')}/></TouchableOpacity>
          <View style={{flexDirection: 'column', margin: 10}}>
            <Text style={{color:'black', fontWeight: 'bold', fontFamily:'Times-Roman'}}>Rice</Text>
            <Text style={{color:'dimgray', fontWeight:'300'}}>50kg</Text>
            <View style={{borderWidth:.5, borderColor: '#1b9862', padding:5, margin:3, width:200, backgroundColor:'#f6f9ff'}}>
              <Text style={{color:'red',  fontWeight:'300'}}>Bidding Price: ₹{bp6}</Text>
              <Text style={{color:'green', fontWeight:'300'}}>Base Price: ₹25</Text>
            </View>
            <View style={{flexDirection:'row', marginTop:5, ...styles.center }}>
                <Text style={{color:'blue'}}>Status: <Text style={{color:'red'}}>Unsold</Text></Text>
                <TouchableOpacity onPress={()=>{setText6('Selected');setColor6('red')}} style={{marginLeft: 30, padding:10, paddingTop:5, paddingBottom:5, backgroundColor:color6, borderRadius:5}}><Text style={{color:'white'}}>{text6}</Text></TouchableOpacity>
            </View>
          </View>
        </View>
        <View style={{backgroundColor: 'rgb(185, 185, 185)', width:'100%', height: 1}}></View>
        ...
        <View style={{flexDirection:'row', ...styles.center}}>
          ...
          <View style={{flexDirection: 'column', margin: 10}}>
            ...
            <View style={{borderWidth:.5, borderColor: '#1b9862', padding:5, margin:3, width:200, backgroundColor:'#f6f9ff'}}>
              <Text style={{color:'red',  fontWeight:'300'}}>Bidding Price: ₹{bp7}</Text>
              <Text style={{color:'green', fontWeight:'300'}}>Base Price: ₹70</Text>
            </View>
            <View style={{flexDirection:'row', marginTop:5, ...styles.center }}>
                <Text style={{color:'blue'}}>Status: <Text style={{color:'red'}}>Unsold</Text></Text>
                <TouchableOpacity onPress={()=>{setText7('Selected');setColor7('red')}} style={{marginLeft: 30, padding:10, paddingTop:5, paddingBottom:5, backgroundColor:color7, borderRadius:5}}><Text style={{color:'white'}}>{text7}</Text></TouchableOpacity>
            </View>
          </View>
        </View>
